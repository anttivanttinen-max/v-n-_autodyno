...
(() => {
 ...
 function ensureBootLogic(){const loadSplash=()=>{if(!globalThis.MotoLabSplash&&!document.querySelector('script[data-ml-splash-early]'))loadScript('./splash_boot.js?build='+encodeURIComponent(BUILD),'mlSplashEarly')};if(!navigator.serviceWorker?.controller&&!globalThis.MotoLabUser&&!document.querySelector('script[data-ml-identity-early]'))loadScript('./user_identity.js?build='+encodeURIComponent(BUILD),'mlIdentityEarly',()=>loadScript('./password_login.js?build='+encodeURIComponent(BUILD),'mlPasswordEarly',loadSplash));else{if(!globalThis.MotoLabPassword&&!document.querySelector('script[data-ml-password-early]'))loadScript('./password_login.js?build='+encodeURIComponent(BUILD),'mlPasswordEarly',loadSplash);else loadSplash()}}
