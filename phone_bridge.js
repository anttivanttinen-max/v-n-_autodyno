...
function mount(){
 ...
 const modal=document.createElement('div');modal.id='phoneBridgeModal';modal.style.cssText='position:fixed;inset:0;z-index:100200;display:none;background:rgba(0,0,0,.78);align-items:flex-end;justify-content:center;padding:8px 8px calc(var(--ml-bottom-nav-h,76px) + 18px + env(safe-area-inset-bottom))';
 modal.innerHTML=`<div style="width:min(100%,440px);max-height:calc(100dvh - var(--ml-bottom-nav-h,76px) - 42px - env(safe-area-inset-bottom));overflow:auto;-webkit-overflow-scrolling:touch;border-radius:22px 22px 14px 14px;background:linear-gradient(#121419,#08090c);border:1px solid rgba(255,38,63,.55);padding:13px;box-shadow:0 20px 60px #000">
