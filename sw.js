const CACHE="vana-motolab-v32-raw-auto-sync";
const CORE=["./manifest.webmanifest","./bike.png","./icon-192.png","./icon-512.png","./vehicle_lookup.js","./vehicle_catalog.json","./maintenance.js","./maintenance_catalog.json","./technical_specs.js","./gps_master_learning.js","./raw_sync.js"];
...
function injectModules(html){
 ...
 if(!html.includes("gps_master_learning.js"))scripts.push('<script src="./gps_master_learning.js?v=32.2"></script>');
 if(!html.includes("raw_sync.js"))scripts.push('<script src="./raw_sync.js?v=32.1"></script>');
