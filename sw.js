importScripts('./version.js?build=2026-09-07-mic-primary-v1');
importScripts('./sw_mic_primary_patch.js?build=2026-09-07-mic-primary-v1');

const VERSION=globalThis.MOTOLAB_RELEASE?.version||'34.9';
const LABEL=globalThis.MOTOLAB_RELEASE?.label||'v34.9 BETA';
const BUILD=globalThis.MOTOLAB_RELEASE?.build||'2026-09-07-mic-primary-v1';
...
function inject(html){
 html=globalThis.MOTOLAB_MIC_PRIMARY_SW_PATCH?globalThis.MOTOLAB_MIC_PRIMARY_SW_PATCH(html):html;
