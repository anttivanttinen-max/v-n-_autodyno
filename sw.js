...
function injectModules(html){
 ...
 if(!html.includes("trip_gear_guard.js"))scripts.push('<script src="./trip_gear_guard.js?v='+V+'&build='+B+'"></script>');
 if(!html.includes("trip_gear_marker.js"))scripts.push('<script src="./trip_gear_marker.js?v='+V+'&build='+B+'"></script>');
